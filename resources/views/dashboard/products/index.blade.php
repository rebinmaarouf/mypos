                    ...
                    <form action="{{ route('dashboard.products.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->check() && auth()->user()->hasPermission('products_create'))
                            ...
                            <tbody>
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td>{{ $product->category->getTranslation('name', app()->getLocale())['name'] ?? 'Default Name' }}
                                        </td>
                                        ...
                                        <td>{{ $product->stock }}</td>
                                        <td>
                                            @if (auth()->check() && auth()->user()->hasPermission('products_update'))
                                            ...
                                            @endif
                                            @if (auth()->check() && auth()->user()->hasPermission('products_delete'))
