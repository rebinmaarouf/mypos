...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{ route('dashboard.welcome') }}"><i class="fa fa-dashboard"></i> @lang('site.categories')</a></li>
                    ...
                    <form action="{{ route('dashboard.categories.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->check() && auth()->user()->hasPermission('categories_create'))
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach ($categories as $index => $category)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $category->getTranslation('name', app()->getLocale())['name'] ?? 'Default Name' }}
                                        </td>
                                        ...
                                        <td>
                                            @if (auth()->check() && auth()->user()->hasPermission('categories_update'))
                                            ...
                                            @endif
                                            @if (auth()->check() && auth()->user()->hasPermission('categories_delete'))
