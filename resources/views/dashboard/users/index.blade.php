                            ...
                            <tbody>
                                @foreach ($users as $index => $user)
                                    <tr>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        <td><img src="{{ $user->image_path }}" style="width: 50px;height:100px;"
                                                class="img-thumbnail" alt=""></td>
                                        <td>
                                            @if (auth()->check() && auth()->user()->hasPermission('users_update'))
                                            ...
                                            @endif
                                            @if (auth()->check() && auth()->user()->hasPermission('users_delete'))
