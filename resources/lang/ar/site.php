...
return [
    ...
    'ar' => [
        ...
        'unique' => 'الاسم بالعربية موجود مسبقًا.',
    ],

    'en' => [
        'name' => 'الاسم بالغه الانجليزيه',
        'description' => 'الوصف بالغه الانجليزيه',
        'unique' => 'الاسم بالإنجليزية موجود مسبقًا.'
    ],
    'custom' => [
        'ar.name.unique' => 'الاسم بالعربية موجود مسبقًا.',
        'en.name.unique' => 'الاسم بالإنجليزية موجود مسبقًا.',
    ],
    'attributes' => [
